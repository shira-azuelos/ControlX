...
public interface ChatMessageRepository extends JpaRepository<ChatMessage, Long> {
    ...
    //  שליפת היסטוריית שיחה פרטית בין מנהל וסוכן במשימה
    ...
    //  סימון הודעות כנקראו בשיחה הספציפית הזו
    @Modifying
    ...
    // ספירת הודעות שלא נקראו עבור משתמש מסוים מול סוכן מסוים במשימה
    ...
    // מביא את ההודעה האחרונה שנשלחה במשימה מסוימת
